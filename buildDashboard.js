...
const SHARED_STYLE = `
  ...
  #btc-chart { display: block; width: 100%; height: 320px; cursor: crosshair; border-radius: var(--radius-sm); background: var(--clr-bg); }
  ...
  .clear-draw-btn { background: none; border: 1px solid var(--clr-border); color: var(--clr-text-muted); border-radius: var(--radius-sm); padding: 5px 10px; font-size: 0.75rem; cursor: pointer; flex-shrink: 0; transition: border-color 0.15s ease, color 0.15s ease; }
...
<body>
  ...
  <div class="price-widget">
    ...
    <div class="draw-hint">
      <span>✏️ Klik-tarik buat gambar garis analisa -- tersimpan otomatis di browser ini per timeframe</span>
