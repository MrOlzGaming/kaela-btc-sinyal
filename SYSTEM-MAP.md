...
| Liquidation listener real-time | 🟡 KODE VERIFIED, SYSTEMD BELUM AKTIF | `liquidationListener.js` | 13 Sep 2026: ganti Binance (TERBUKTI diblokir IP datacenter) -> Bybit `allLiquidation.BTCUSDT` (TERBUKTI JALAN, diverifikasi 4 lapis dari VPS asli). Tinggal minta izin Olan buat `systemctl enable --now kaela-liquidation-listener` |
